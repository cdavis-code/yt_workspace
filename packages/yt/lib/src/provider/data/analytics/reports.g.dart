...
class _ReportsClient implements ReportsClient {
  ...
  Future<AnalyticsReport> query(
    ...
    final queryParameters = <String, dynamic>{
      ...
      r'currency': currency,
      r'includeHistoricalChannelData': includeHistoricalChannelData,
    };
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{r'Accept': accept};
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AnalyticsReport>(
    ...
    late AnalyticsReport _value;
    try {
      _value = AnalyticsReport.fromJson(_result.data!);
    } on Object catch (e, s) {
