...
base class MCPServerWithTools extends MCPServer with ToolsSupport {
  ...
  String _buildJsWrapper(String userCode) {
    ...
    sb.writeln("async function external_yt_video_abuse_report_reasons_list(args) { return call_tool('yt_video_abuse_report_reasons_list', args); }");
    sb.writeln();
  ...
  dynamic _dispatchCodeModeToolCall(String toolName, Map<String, dynamic> args) async {
    ...
    switch (toolName) {
      ...
      case 'yt_video_abuse_report_reasons_list': result = await _yt_video_abuse_report_reasons_list(request); break;
      default:
